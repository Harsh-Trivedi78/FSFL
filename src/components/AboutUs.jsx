    ...
    <section className="bg-gray-100 py-16">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-orange-500">About Four Season Spice London</h1>
          <p className="mt-4 text-lg text-gray-600">Experience the taste of authentic Indian spices, crafted with love and tradition.</p>
        </div>
